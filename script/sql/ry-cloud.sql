...
insert into sys_config values(1761700000000000003, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'Y', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '深色主题theme-dark，浅色主题theme-light');
insert into sys_config values(1761700000000000005, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '是否开启注册用户功能（true开启，false关闭）');
