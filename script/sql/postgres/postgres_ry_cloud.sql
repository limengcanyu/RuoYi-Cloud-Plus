...
insert into sys_menu values(1761400000000000110, 'SnailJob控制台', 1761400000000000002, 2, 'http://localhost:8800/snail-job', '', '', 'Y', 'Y', 'C', '0', '0', 'monitor:job:list', 'job', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, 'SJ定时任务菜单');
...
insert into sys_config values(1761700000000000001, '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow');
insert into sys_config values(1761700000000000002, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, '初始化密码 123456');
insert into sys_config values(1761700000000000003, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, '深色主题theme-dark，浅色主题theme-light');
insert into sys_config values(1761700000000000005, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, '是否开启注册用户功能（true开启，false关闭）');
insert into sys_config values(1761700000000000011, 'OSS预览列表资源开关', 'sys.oss.previewListResource', 'true', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, 'true:开启, false:关闭');
